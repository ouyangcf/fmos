...
public class MachineFeatureDetail {
    private Integer lineId;

    private BigDecimal infoValue;

    private Integer instanceLineId;

    private Integer featureHeadLineId;
    ...
    public void setInfoValue(BigDecimal infoValue) {
    ...
    public Integer getFeatureHeadLineId() {
        return featureHeadLineId;
    }

    public void setFeatureHeadLineId(Integer featureHeadLineId) {
        this.featureHeadLineId = featureHeadLineId;
    }
